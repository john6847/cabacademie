            ...
            <form name="courseForm">
                ...
                <div class="row form-group">
                    <div class="col-md-6 col-xs-12">
                        ...
                        <span style="color: red;" ng-show="courseForm.category.$invalid && (courseForm.category.$dirty || courseForm.category.$touched)">Catégory invalide!</span>
                    </div>
                    <div class="col-md-6 col-xs-12">
                        <label class="control-label" for="startDate">Début du cours</label>
                        <input type="date" submit-required="true"  data-date-format="dd/MMMM/yyyy" class="form-control"  id="startDate" ng-model="rc_ctrl.course.startDate" placeholder="Debut du Cours" title="Choisit la dâte du debut" required>
                ...
                <md-card-actions layout="row" layout-align="end center">
                    ...
                    <md-button type="submit" class="md-raised md-primary" ng-disabled="courseForm.$invalid" ng-click="rc_ctrl.register()">Enregistrer</md-button>
                </md-card-actions>
            </form>
</div>
</md-content>
