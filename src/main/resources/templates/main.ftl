    ...
    <nav class="fh5co-nav" role="navigation">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xs-12 text-right">
                        <p class="site">www.cabacademie.com</p>
        ...
        <div class="top-menu">
            <div class="container">
                <div class="row">
                    <div class="col-xs-2">
                        <div id="fh5co-logo"><a href="index.html"><i class="icon-study"></i>CabAcademie<span>.</span></a></div>
                    </div>
            ...
            <div class="row">
                <div class="pricing pricing--rabten">
                    <div class="col-md-4 animate-box">
                        <div class="pricing__item">
                            <div class="wrap-price">
                                <!-- <div class="icon icon-user2"></div> &ndash;&gt;
                                <h3 class="pricing__title">Trial</h3>
                                <!-- <p class="pricing__sentence">Single user license</p> &ndash;&gt;
                            </div>
                    ...
                    <div class="col-md-4 animate-box">
                        <div class="pricing__item">
                            <div class="wrap-price">
                                <!-- <div class="icon icon-store"></div> &ndash;&gt;
                                <h3 class="pricing__title">Silver</h3>
                                <!-- <p class="pricing__sentence">Up to 5 users</p> &ndash;&gt;
                            </div>
                            <div class="pricing__price">
                                    <span class="pricing__anim pricing__anim--1">
                    ...
                    <div class="col-md-4 animate-box">
                        <div class="pricing__item">
                            <div class="wrap-price">
                                <!-- <div class="icon icon-home2"></div> &ndash;&gt;
                                <h3 class="pricing__title">Gold</h3>
                                <!-- <p class="pricing__sentence">Unlimited users</p> &ndash;&gt;
                            </div>
                            <div class="pricing__price">
                                    <span class="pricing__anim pricing__anim--1">
